...
import men1 from "../assets/products.jpeg";
import men2 from "../assets/products2.jpeg";
import men3 from "../assets/products3.jpeg";
import men4 from "../assets/products4.jpeg";
...
const MenProducts = () => {
  ...
  const menProducts = [
    { id: 1, img: men1, title: "Yellow Coat Jacket", price: "$125" },
    { id: 1, img: men2, title: "Yellow Coat Jacket", price: "$785" },
    { id: 1, img: men3, title: "Yellow Coat Jacket", price: "$532" },
    { id: 1, img: men4, title: "Yellow Coat Jacket", price: "$451" },
    { id: 1, img: men1, title: "Yellow Coat Jacket", price: "$462" },
  ];
  return (
    <div>
